...
{
    // Producer/Publisher für Nachrichten bezüglich der Bundesliga (1. & 2. Liga)
    class Pub_Buli
    {
        static void Main(string[] args)
        {
            ...
            string clientId = "client_Pub_Buli_"; // sinnhafte Benamung, um über Webinterface auf Client schließen zu können
             ...
             *   Außerdem rufen wir Publish() hier zweimal auf, da unser Client Nachrichten für zwei verschiedene Topics verschickt.
             *       - /buli1 für 1. Bundesliga
             *       - /buli2 für 2. Bundesliga
             */
            ushort msgId_buli1 = client.Publish("/buli1", // Topic, das publishedt wird
